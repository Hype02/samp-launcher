    ...
    class SampApi {
        ...
        static async GetAllServersList() {
            ...
            for (let i = 0; i < fetchedServersArray.length; i++) {
                ...
                console.log("srv " + JSON.stringify(fetchedServersArray[i]));
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			add_location(div, file, 43, 0, 1419);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:0) {#each servers as server}",
    		ctx
    	});
